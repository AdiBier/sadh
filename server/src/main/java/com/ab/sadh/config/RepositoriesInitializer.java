...
public class RepositoriesInitializer {
    ...
    @Autowired
    public RepositoriesInitializer(UsersRepository usersRepository, @Lazy PasswordEncoder passwordEncoder, @Lazy ProductsRepository productsRepository, @Lazy MissionsRepository missionsRepository) {
    ...
    @Bean
    InitializingBean initializingBean() { //TODO
        return () -> {
